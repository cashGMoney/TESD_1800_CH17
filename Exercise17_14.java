...
public class Exercise17_14 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("Exercise17_14.dat"))) {
        ...
        outputData("Exercise17_14.dat");
    }

    // A a void function called outputData that reads the Loan objects from the file and displays the total loan amount. 
